...
public class JGrafo {
    ...
    public static class Aresta {
        private int v1, v2, distancia, tempo;//Classe  Aresta com os atributos v1, v2 e peso
    ...
    public void imprime () {
        ...
        for (int i = 0; i < this.numVertices; i++) {
            ...
            for (int j = 0; j < this.numVertices; j++)
                System.out.print("Distancia" + this.mat[i][j][0] + "Tempo: " + this.mat[i][j][1] + "  ");
            System.out.println();
        }
    }
